...
#define SECRET_SSID "Maxis_9FF4CF"
#define SECRET_PASS "53699895"
...
#define IP_ADDRESS "192.168.0.100" //previous ip : 10,0,3,21, replace that ip to match the IP of the device where the broker is running
