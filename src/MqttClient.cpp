...
void MqttClient::subscribeRoutine() {
  if (mqttClient.connect(mqtt_username)) {
    ...
    mqttClient.subscribe(sub_f1_st1_ontime, 1);
    mqttClient.subscribe(sub_f1_st1_offtime, 1);
    mqttClient.subscribe(sub_f1_st2_ontime, 1);
    mqttClient.subscribe(sub_f1_st2_offtime, 1);
    mqttClient.subscribe(sub_f1_ccw_st2_ontime, 1);
    mqttClient.subscribe(sub_f1_ccw_st2_offtime, 1);
    ...
    mqttClient.subscribe(sub_f1_ccw_st3_ontime, 1);
    mqttClient.subscribe(sub_f1_ccw_st3_offtime, 1);
    mqttClient.subscribe(sub_s1_st3_ontime, 1);
    mqttClient.subscribe(sub_s1_st3_offtime, 1);
    mqttClient.subscribe(sub_A, 1);
    mqttClient.subscribe(sub_B, 1);
